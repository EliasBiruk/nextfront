    ...
    <DashboardLayout actor="admin" userName={currentUser?.firstName || 'Administrator'}>
      ...
      <Card>
        <CardBody>
          ...
          <p className="text-gray-600 mt-4">This page allows administrators to send notifications to users.</p>
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">Features coming soon: Compose notifications, target specific users, schedule delivery</p>
          </div>
        </CardBody>
      </Card>
    </DashboardLayout>
